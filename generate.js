...
function hdr(prefix) {
  ...
  <div class="hdr-row">
    ...
    <div class="hdr-links">
      <a href="mailto:avigailba@gmail.com" class="hdr-link">Contact</a>
      <a href="https://www.linkedin.com/in/avigailbahat/" target="_blank" rel="noreferrer" class="hdr-link">LinkedIn</a>
      <a href="https://docs.google.com/document/d/1f0pEtgv_I89h16hgUF0ncW52EBcFwVPrjrJFzW3teI4/export?format=pdf" target="_blank" rel="noreferrer" class="hdr-link">CV</a>
    </div>
...
function projectPage(proj, prevProj, nextProj) {
  ...
  if (proj.slug === 'ai-credits-wallet' && contentHtml) {
    ...
    if (splitIdx !== -1) {
      ...
      contentHtml =
        `<style>@media(max-width:768px){.cw-widget-col{display:none!important;}.cw-grid{grid-template-columns:1fr!important;}}.cw-grid>div>h2:first-child{margin-top:0;}</style>` +
        intro +
